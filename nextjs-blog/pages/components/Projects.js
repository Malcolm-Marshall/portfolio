  ...
  return (
    <Container>
      ...
      <h4>
        ...
        <Col>
          <p>
          During three weeks, myself and three other engineers were tasked with creating an e-commerce web app that includes a product overview, comparison tools and outfit builder, user questions and answers, and a ratings and reviews breakdown. I took ownership of the questions and answers section. The top questions about the product would be displayed, along with the top-rated answers for that specific question. As a user, you would be able to rank both the questions and answers, as well as add your own. There is a search bar included which allows the user to search for keywords in either the questions or their corresponding answers. A challenge I faced while working on this project was re-rendering the page too many times while using the search bar since it would re-search the questions and answers with each key press. I modified where I was accessing the data so that when the search bar was searching, it would be searching a static version that would not trigger excessive re-renders.
          </p>
